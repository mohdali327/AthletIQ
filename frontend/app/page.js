...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col relative z-10 pb-12">
      {/* ── HEADER ── */}
      <header className="w-full flex items-center justify-between px-8 py-6 border-b border-[rgba(255,255,255,0.05)] bg-[rgba(11,8,25,0.8)] backdrop-blur-md sticky top-0 z-50">
        ...
        <nav className="custom-tabs-container !m-0">
          {[
            'Pathway Overview', 'Profile Directory', 'Centres & Academies', 
            'Sponsor Pipeline', 'Data Quality'
          ].map(tab => (
            <button
              key={tab}
            ...
            >
              ...
              {activeTab === 'Profile Directory' && (
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 acard mt-4 mb-6">
                    <div>
                      <label className="text-xs font-bold text-slate-300 uppercase tracking-widest block mb-2">Choose Sport Filter</label>
                      <select 
                        value={selectedSport} 
                    ...
                    <div>
                      <label className="text-xs font-bold text-slate-300 uppercase tracking-widest block mb-2">Choose State Filter</label>
                      <select 
                        value={selectedState} 
                  ...
                  {/* Selectors for Athlete Search / bio */}
                  <div className="acard">
                  ...
                  {profileSelectedAthlete !== '-- Select Athlete --' ? (
                    ...
                    // LEVEL SELECTION TAB BUTTONS (Our new feature!)
                    <div className="mt-8">
              ...
              {activeTab === 'Centres & Academies' && (
                <div>
                  ...
                  {/* Styled sub-tab selector that replaces the buggy Streamlit tabs */}
                          ...
                          {matchingResults ? (
                            <div className="space-y-4">
                              {matchingResults.map((r, idx) => (
                                <div key={idx} className="p-4 rounded-xl border border-teal-500/10 bg-teal-500/5 flex items-center justify-between">
                                  <div>
              ...
              {activeTab === 'Data Quality' && (
                <div>
                  <div className="stitle">
                    Data Quality <span className="chip chip-red">Registry Status Sync</span>
                  </div>

                  <div className="acard mt-4 max-w-lg mx-auto">
                    <h3 className="font-bold text-white mb-6">Database Health Indicators</h3>
                    <div className="space-y-4">
                      <div>
                        <div className="flex justify-between text-xs font-bold text-slate-300 uppercase tracking-widest mb-1">
                          <span>Complete Bio-Data Records</span>
                          <span className="text-[#10E5B3]">94%</span>
                        </div>
                        <div className="dq-bar-wrap">
                          <div className="dq-bar bg-[#10E5B3]" style={{ width: '94%' }}></div>
                        </div>
                      </div>
                      <div>
                        <div className="flex justify-between text-xs font-bold text-slate-300 uppercase tracking-widest mb-1">
                          <span>Source URL Reference verified</span>
                          <span className="text-[#10E5B3]">88%</span>
                        </div>
                        <div className="dq-bar-wrap">
                          <div className="dq-bar bg-[#10E5B3]" style={{ width: '88%' }}></div>
                        </div>
                      </div>
                      <div>
                        <div className="flex justify-between text-xs font-bold text-slate-300 uppercase tracking-widest mb-1">
                          <span>Coaching certificates validated</span>
                          <span className="text-amber-300">76%</span>
                        </div>
                        <div className="dq-bar-wrap">
                          <div className="dq-bar bg-amber-400" style={{ width: '76%' }}></div>
                        </div>
                      </div>
                    </div>
                  </div>
