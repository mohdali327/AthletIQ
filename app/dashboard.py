...
<div class="stitle sticky-header" title="Strategic Dashboard Homepage" style="margin-top:0;"> Pathway Overview <span class="chip chip-blue">Strategic Dashboard Homepage</span></div>""", unsafe_allow_html=True)
    ...
    st.markdown('''
    <div class="acard anim-fade-up delay-1" style="border-left:3px solid var(--purple);margin-bottom:0.6rem;padding:0.8rem 1.2rem;">
    ...
    <div class="acard anim-fade-up delay-2" style="border-left:3px solid var(--teal);margin-bottom:0.6rem;padding:0.8rem 1.2rem;">
    ...
    <div class="acard anim-fade-up delay-3" style="border-left:3px solid var(--gold);margin-bottom:0.6rem;padding:0.8rem 1.2rem;">
